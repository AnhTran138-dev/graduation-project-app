...
import ReportInspectionSchedule from '~/components/screens/report-detail/report-inspection-schedule';
      ...
      <ScrollView>
        <View className="h-full gap-2 ">
          ...
          <View
            ...
            {reportDetail?.inspectionScheduleDetail && (
              <ReportInspectionSchedule
                inspectionScheduleDetail={reportDetail.inspectionScheduleDetail}
              />
            )}
            {reportDetail?.compensationDetail && (
              <ReportProofForm
